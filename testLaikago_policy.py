import sys, os
import simulation.Laikago_pybullet_env as e
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--PolicyDir', help='directory of the policy to be tested', type=str, default='01_07')
    parser.add_argument('--WedgeIncline', help='wedge incline degree of the wedge', type=int, default=5)
